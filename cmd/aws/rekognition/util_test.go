...
var compareFacesOutputMock = pkgRek.CompareFacesOutput{
	CompareFacesOutput: &rekognition.CompareFacesOutput{
...
var detectFacesOutputMock = pkgRek.DetectFacesOutput{
	DetectFacesOutput: &rekognition.DetectFacesOutput{
...
var detectTextMock = pkgRek.DetectTextOutput{
	DetectTextOutput: &rekognition.DetectTextOutput{
...
func TestUnmarshalRekognitionOut(t *testing.T) {
	...
	outErr := unmarshalRekognitionOut(compareFacesOutputMock.CompareFacesOutput, &out)
